...
public class SupplierService {
    ...
    public SupplierDto createSupplier(SupplierDto supplierDto) {
        SupplierEntity existingSupplier = supplierRepository.find("supplierIndex", supplierDto.getSupplierIndex()).firstResult();
        if (existingSupplier != null) {
            throw new DuplicateException("Supplier with index " + supplierDto.getSupplierIndex() + " already exists");
        }
