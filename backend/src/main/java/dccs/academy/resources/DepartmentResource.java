...
public class DepartmentResource {
    ...
    public Response getDepartments() {
        try {
            return ResponseHandler.successResponse("Departments retrieved successfully", departmentService.getDepartments(), Response.Status.OK);
        } catch (Exception e) {
    ...
    public Response createDepartment(DepartmentDto departmentDto) {
        try {
            ...
            return ResponseHandler.successResponse("Department created successfully", created, Response.Status.CREATED);
        } catch (Exception e) {
    ...
    public Response updateDepartment(@PathParam("id") Long id, DepartmentDto departmentDto) {
        try {
            ...
            return ResponseHandler.successResponse("Department updated successfully", updated, Response.Status.CREATED);
    ...
    public Response getDepartment(@PathParam("id") Long id) {
        try {
            ...
            return ResponseHandler.successResponse("Department retrieved successfully", department, Response.Status.OK);
        } catch (EntityNotFoundException e) {
            return ResponseHandler.errorResponse(e.getMessage(), Response.Status.NOT_FOUND);
        }
    }
