...
public class UserResource {
  ...
  public Response getUsers() {
    try {
      return ResponseHandler.successResponse(
          "Users retrieved successfully", userService.getUsers(), Response.Status.OK);
    } catch (Exception e) {
  ...
  public Response searchUsers(
    ...
    try {
      List<UserDto> users =
          userService.searchUsers(firstName, lastName, userIndex, email, plant, departmentName);
      return ResponseHandler.successResponse(
          "Search results retrieved successfully", users, Response.Status.OK);
    } catch (Exception e) {
      return ResponseHandler.errorResponse(e.getMessage(), Response.Status.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  public Response createUser(UserDto userDto) {
    try {
      ...
      return ResponseHandler.successResponse(
          "User created successfully", created, Response.Status.CREATED);
  ...
  public Response updateUser(@PathParam("id") Long id, UserDto userDto) {
    try {
      ...
      return ResponseHandler.successResponse(
          "User updated successfully", updated, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseHandler.errorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (DuplicateException e) {
      return ResponseHandler.errorResponse(e.getMessage(), Response.Status.CONFLICT);
  ...
  public Response getUser(@PathParam("id") Long id) {
    try {
      ...
      return ResponseHandler.successResponse(
          "User retrieved successfully", user, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseHandler.errorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    }
  }
